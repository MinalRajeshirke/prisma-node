/*
  ...
  - You are about to alter the column `wishlist_id` on the `wishlist` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Int`.
...
ALTER TABLE `wishlist` DROP PRIMARY KEY,
    MODIFY `wishlist_id` INTEGER NOT NULL AUTO_INCREMENT,
    MODIFY `userId` INTEGER NOT NULL,
